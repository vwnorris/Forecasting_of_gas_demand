...
class RNN(nn.Module):
    def __init__(self, configs):
        ...
        self.hidden_dim = configs.d_model  # Hidden state dimension
    ...
    def forward(self, x):
        ...
        return out.view(batch_size, self.pred_len, self.output_dim)  # Reshape to (batch_size, pred_len, output_dim)
